/**
 * Top 20 holdings for each SPDR sector ETF.
 * These reflect the sector's largest constituents by index weight; the exact
 * order shifts slightly week-to-week but the names are stable. Sourced from
 * the official SPDR fund pages.
 */

export type Holding = { ticker: string; name: string }
